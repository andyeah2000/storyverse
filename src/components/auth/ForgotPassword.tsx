...
import { ArrowLeft, ArrowRight, Loader2, Mail, CheckCircle, Moon, Sun } from 'lucide-react';
        ...
        <div className="w-full max-w-[360px]">
          {isSubmitted ? (
            ...
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-emerald-100 dark:bg-emerald-500/10 flex items-center justify-center mx-auto mb-6">
              ...
              <p className={`text-[15px] mb-8 ${isDark ? 'text-stone-400' : 'text-stone-500'}`}>
                ...
                <span className={`font-medium ${isDark ? 'text-white' : 'text-stone-900'}`}>{email}</span>
              </p>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className={`w-full h-[52px] rounded-xl font-medium transition-all active:scale-[0.98] ${
                    isDark 
              ...
              <p className={`text-xs mt-8 ${isDark ? 'text-stone-500' : 'text-stone-400'}`}>
            ...
            <>
              <div className="text-center mb-10">
                <div className={`w-14 h-14 rounded-xl flex items-center justify-center mx-auto mb-6 ${
                  ...
                  <Mail size={24} className={isDark ? 'text-stone-400' : 'text-stone-500'} />
                </div>
